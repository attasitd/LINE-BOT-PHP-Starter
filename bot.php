	...
	foreach ($events['events'] as $event) {
		...
		if ($event['type'] == 'message' && $event['message']['type'] == 'text') {
			...
			if (strlen($text)==13){
				...
				echo $data_a;
				if ($data_a == "OK"){
					$text = $text2 . '  หมายเลขลงทะเบียนเรียบร้อยแล้ว....  <หากมีปัญหากรุณาติดต่อผู้ดูแลระบบ จัดทำโดยงานศูนย์ข้อมูลสารสนเทศ วิทยาลัยการอาชีพนวมินทราชินีแม่ฮ่องสอน [Attasit Datsong:OK]>';
				}else if ($data_a == "DUP"){
